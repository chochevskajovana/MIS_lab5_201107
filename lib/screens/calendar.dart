...
class _CalendarScreenState extends State<CalendarScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Lab4-201107"),
        backgroundColor: Theme.of(context).colorScheme.inversePrimary,
        actions: [
          ElevatedButton(
            onPressed: () => _addExam(),
            style: const ButtonStyle(
              backgroundColor: MaterialStatePropertyAll<Color>(Color.fromRGBO(49, 49, 131, 1)),
            ),
            child: const Text(
              "Add exam",
          ...
          ElevatedButton(
            ...
            style: const ButtonStyle(
              backgroundColor: MaterialStatePropertyAll<Color>(Color.fromRGBO(42, 147, 209, 1)),
            ),
            child: const Text(
              "Sign out",
        ...
        children: [
          TableCalendar(
            ...
            calendarStyle: CalendarStyle(
              weekendTextStyle: TextStyle().copyWith(color: Colors.purple),
